...
using Mmu.CleanDddSimple.Infrastructure.CrossCutting.LanguageExtensions.Invariance.Servants;

namespace Mmu.CleanDddSimple.Infrastructure.CrossCutting.LanguageExtensions.Invariance
{
    [PublicAPI]
